...
function failoverBlock({ jsx, react }) {
  return [
    ...
    `  const _title = _isAuto ? \`All subscription quotas are exhausted\` : \`Automatic routing is off\`;`,
    ...
    `        : \`Reset time unknown.\`)`,
    `    : \`Enable it from the account menu so chats fail over automatically when a quota is hit.\`;`,
    ``,
