...
function block({ jsx, menu, item, react }) {
  ...
  return [
    ...
    `const _pin=_p.pinned?(0,${jsx}.jsx)(\`span\`,{title:\`This chat is pinned to this account\`,className:\`shrink-0 rounded-sm border px-1 leading-4 text-codex-description\`,style:{borderColor:\`var(--color-border-subtle)\`,fontSize:\`10px\`},children:\`This chat\`}):null;`,
    ...
    `_pin||_sub?(0,${jsx}.jsxs)(\`span\`,{className:\`flex min-w-0 items-center gap-1 text-xs text-codex-description\`,children:[_pin,_sub?(0,${jsx}.jsx)(\`span\`,{className:\`truncate\`,children:_sub}):null]}):null]}),_right]}),`,
